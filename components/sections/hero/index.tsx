  ...
  return (
    <section className="lg:bg-hero-section bg-hero-section-mobile flex flex-col items-center justify-between overflow-hidden rounded-3xl px-3 py-9 max-lg:gap-6 lg:flex-row lg:py-3 xl:rounded-[32px] 2xl:p-4 3xl:rounded-[48px] 3xl:p-6">
      <div className="relative z-10 flex flex-col gap-4 px-4 lg:gap-8 lg:px-6 xl:px-4 2xl:gap-4 3xl:gap-2 3xl:px-8">
        <div className="flex flex-col gap-1 3xl:pb-7">
          <h1 className="whitespace-nowrap text-2xl leading-none lg:text-[40px] xl:text-3xl 2xl:text-h2 3xl:text-h1">
            Discover and trade
          </h1>
          <h1 className="inline-flex gap-3 text-2xl leading-none lg:gap-5.5 lg:text-[40px] xl:text-3xl 2xl:text-h2 3xl:text-h1">
            the next
          ...
          <h1 className="inline-flex items-center gap-1 text-2xl leading-none lg:text-[40px] xl:text-3xl 2xl:gap-4 2xl:text-h2 3xl:text-h1">
            on
      ...
      <div className="swap-tool-bg relative w-80 rounded-3xl border border-white-full/40 p-2 xsm:w-full xl:max-w-[388px] xl:py-8 2xl:max-w-[440px] 2xl:py-9 3xl:max-w-swap-tool-container 3xl:px-2.5 3xl:py-10">
        <div className="flex flex-col gap-6 rounded-3xl bg-[#140F34] p-3 xl:pb-2.5 xl:pt-4 2xl:pb-2.5 2xl:pt-5 3xl:pb-3 3xl:pt-5.5">
          <div className="relative flex flex-col gap-0.5 xl:gap-[3px] 2xl:gap-1">
            <div className="flex w-full items-center justify-between rounded-2xl bg-[#282750] pb-5 pl-4.5 pr-4.5 pt-4.5 xl:py-7 xl:pr-3.5 2xl:py-8 2xl:pl-5 2xl:pr-4 3xl:pb-8.5 3xl:pr-4.5 3xl:pt-9">
              <div className="flex items-center gap-2.5 2xl:gap-3">
                ...
                <div className="flex flex-col">
                  <span className="2xl:text-[18px] 3xl:text-xl">USDC</span>
                  <span className="whitespace-nowrap text-[13px] text-[#958FC0] 2xl:text-sm 3xl:text-base">
                    USD Coin
                  </span>
                </div>
              </div>
              <div className="flex flex-col items-end">
                <span className="2xl:text-[18px] 3xl:text-xl">1000</span>
                <span className="whitespace-nowrap text-[13px] text-[#958FC0] 2xl:text-sm 3xl:text-base">
                  ≈ $995
                </span>
              </div>
            ...
            <div className="flex w-full items-center justify-between rounded-2xl bg-[#282750] pb-5 pl-4.5 pr-4.5 pt-4.5 xl:py-7 xl:pr-3.5 2xl:py-8 2xl:pl-5 2xl:pr-4 3xl:pb-8.5 3xl:pr-4.5 3xl:pt-9">
              <div className="flex items-center gap-3">
                ...
                />
                <div className="flex flex-col">
                  <span className="2xl:text-[18px] 3xl:text-xl">TIA</span>
                  <span className="whitespace-nowrap text-[13px] text-[#958FC0] 2xl:text-sm 3xl:text-base">
                    Celestia
                  </span>
                </div>
