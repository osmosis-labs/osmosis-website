    ...
    <section className="bg-earn-section relative z-10 mt-14 flex flex-col rounded-3xl pt-4 sm:rounded-4xl md:mt-16 md:pt-12 lg:rounded-3xl lg:pt-4 xl:mt-18 xl:rounded-4xl xl:pt-8">
      <div className="flex flex-col gap-6 px-2 py-4 sm:p-4 lg:gap-8 2xl:items-start 2xl:gap-14 2xl:p-6">
        <div className="flex flex-col gap-4 2xl:gap-6">
          ...
          <h2 className="bg-earn-headline xl:text-5.5xl font-poppins text-3.5xl font-medium leading-[38.5px] -tracking-[0.64px] md:text-4xl md:leading-[44px] md:-tracking-[0.72px] lg:text-5xl lg:leading-[58px] lg:-tracking-[0.96px] xl:leading-[68px] xl:-tracking-[1.12px] 2xl:text-[64px] 2xl:leading-[80px] 2xl:-tracking-[1.28px]">
